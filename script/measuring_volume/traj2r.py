...
CM_CENTER_DS = float(POS_BASE) + 0.2
BASE_BASE = 0.3897628551303122

RC2_BACK = float(EXCL_RC1)**2
RC2_BASE = float(EXCL_RC2)**2
RC2_BACK_BASE = float(EXCL_RC3)**2
...
if xyz:
    outfile = conffile + '.rxyz'
elif pdb:
    outfile = conffile + '.rpdb'
out = open (outfile, 'w')
...
while True:
    ...
    if xyz:
        ...
        for i in range(nnucl):
            ...
            # print(out, "%lf %lf %lf" % (rnow[0], rnow[1], rnow[2]))
            out.write(str("%lf %lf %lf" % (rnow[0], rnow[1], rnow[2]) + "\n"))
    elif pdb:
        # header
...
# traj = ../input/results/oxdna_random_6_diffseq_2/L1/d-1-4-7-10-14-15/L1_d-1-4-7-10-14-15_2023-02-01-020045/L1_d-1-4-7-10-14-15_2023-02-01-020045/last_conf_L1_d-1-4-7-10-14-15_2023-02-01-020045.dat.dat 
# top = ../input/results/oxdna_random_6_diffseq_2/L1/d-1-4-7-10-14-15/L1_d-1-4-7-10-14-15_2023-02-01-020045/L1_d-1-4-7-10-14-15_2023-02-01-020045/generated_L1_d-1-4-7-10-14-15_2023-02-01-020045.top
