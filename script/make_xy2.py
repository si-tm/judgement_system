...
def make_xy_ratioB(dirs, target_name, seq_csv):
    dic_x = gx.load_x("../data/dic/x_random_l3_6.pkl")
    dic_y = gy.load_y("../data/dic/L3_data_4.pkl")
    x_lst = mis.seq_lst(seq_csv)
...
def test():
    ...
    # make_xy_dv(dirs_random_l1, "random_l2_6", seq_csv_path)
    # make_xy_mean(dirs_random_l1, "random_l2_6", seq_csv_path)
    # print(load_npy("../data/npy/x_random_l2_6_mean.npy"))
    # print(load_npy("../data/npy/y_random_l2_6_mean.npy"))
    # print(load_npy("../data/npy/x_random_l2_6_dv.npy"))
    # print(load_npy("../data/npy/y_random_l2_6_dv.npy"))
    # print(load_npy("../data/npy/x_random_l2_6_rb.npy"))
    # print(load_npy("../data/npy/y_random_l2_6_rb.npy"))
    ...
    # make_xy_dv(dirs_random_l1, "random_l3_6", seq_csv_path)
    # make_xy_mean(dirs_random_l1, "random_l3_6", seq_csv_path)
    # print(load_npy("../data/npy/x_random_l3_6_mean.npy"))
    # print(load_npy("../data/npy/y_random_l3_6_mean.npy"))
    # print(load_npy("../data/npy/x_random_l3_6_dv.npy"))
    # print(load_npy("../data/npy/y_random_l3_6_dv.npy"))
    # print(load_npy("../data/npy/x_random_l3_6_rb.npy"))
    # print(load_npy("../data/npy/y_random_l3_6_rb.npy"))
